...
namespace Enemies
{
    public class CollisionManager : MonoBehaviour
    {
        ...
        private bool HasBreadAlreadyBeenAnalyzed(GameObject breadGameObject, EnemyColliderType radiusType){
            if ((radiusType == EnemyColliderType.Outer &&
                 outerColliderBreadAlreadyAnalyzed.Contains(breadGameObject)) ||
                (radiusType == EnemyColliderType.Medium) &&
                mediumColliderBreadAlreadyAnalyzed.Contains(breadGameObject)) return true;
            return false;
        }
